class Mario {
  constructor(game) {
    ...
    this.stateObject = {
      ...
      runningLeft: {
        frames: [
          new Sprite(this.spritesheets.marioLeft, 96, 32.5, 15, 16),
      ...
      runningRight: {
        frames: [
          new Sprite(this.spritesheets.marioRight, 96, 32.5, 15, 16),
  ...
  update(input, animateFrame) {
    ...
    if (input.includes("ArrowRight") && this.x < this.gameEnd) {
      ...
      if (!this.isJumping && animateFrame % 3 === 0) {
        this.image =
          this.stateObject.runningRight.frames[
      ...
      if (!this.isJumping && animateFrame % 3 === 0) {
        this.image =
          this.stateObject.runningLeft.frames[
          ...
          if (item.type === "brick") {
            ...
            if (
              ...
              if (
                ...
                this.brickParticle = new ParticleSystem(
                  this.spritesheets.tiles,
                  item.x,
                  item.y - 8,
                  4
                );
